...
function getCharacter() {
  const table = {
    1: ['Наивность', 'Агрессивность', 'Адекватность', 'Наглость', 'Женственность', 'Мужественность'],
    2: ['Чёрствость', 'Меркантильность', 'Порядочность', 'Злость', 'Надёжность', 'Зависть'],
    3: ['Находчивость', 'Эгоистичность', 'Оптимизм', 'Пессимизм', 'Осторожность', 'Безалаберность'],
    4: ['Понимание', 'Безответственность', 'Приветливость', 'Безразличие', 'Миролюбие', 'Ветреность'],
    5: ['Мечтательность', 'Гордыня', 'Милосердие', 'Тактичность', 'Лень', 'Трудоголизм'],
    6: ['Терпеливость', 'Мелочность', 'Харизматичность', 'Мудрость', 'Хозяйственность', 'Честность'],
    7: ['Лживость', 'Чуткость', 'Храбрость', 'Трусость', 'Целомудрие', 'Распутность'],
    8: ['Запасливость', 'Транжирство', 'Решительность', 'Неуверенность', 'Опрятность', 'Скромность'],
    9: ['Властность', 'Вульгарность', 'Покорность', 'Мечтательность', 'Молчаливость', 'Напористость'],
    10: ['Обидчивость', 'Высокомерие', 'Ласковость', 'Коллективизм', 'Инфантильность', 'Лицемерие']
  };

  const col = getRandom(1, 10);
  const row = getRandom(1, 6); 
  return table[col][row - 1];
};
